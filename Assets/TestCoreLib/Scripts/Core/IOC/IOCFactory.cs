namespace TestCoreLib
{
    ...
    public class IOCContainer
    {
        ...
        private Dictionary<Type, Dictionary<string, Item>> m_named = new Dictionary<Type, Dictionary<string, Item>>();      //依赖项命名
        private Dictionary<Type, Item> m_registered = new Dictionary<Type, Item>();                                         //注册过的字典
        private Dictionary<Type, Item> m_fallbacks = new Dictionary<Type, Item>();                                          //回退字典
        ...
        public void Register<T>(string name, Func<T> func)
        {
            ...
            {
                Log.Warning($"item with name {name} already registered");
            }
        ...
        public void Register<T>(Func<T> func)
        {
            ...
            {
                Log.Warning($"type {typeof(T).FullName} already registered.");
            }
        ...
        public void RegisterFallback<T>(Func<T> func)
        {
            ...
            {
                Log.Warning($"fallback for type {typeof(T).FullName} already registered.");
            }
