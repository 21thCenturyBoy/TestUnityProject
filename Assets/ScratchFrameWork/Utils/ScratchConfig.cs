...
namespace ScratchFramework
{
    ...
    {
        [Header("Sprite资源引用")] [Header(nameof(BlockType.Condition))]
        ...
        [Space] [Header("HeaderDataItem Prefab 预制体引用")]
        ...
        [Space] [Header("BlockColor基础颜色配置")] public Color BlockColor_Undefined;
        ...
        [Space] [Header("模版配置")] public int Version = 0;
        [Space] public string TemplateDatasPath = "Assets/Resources_UGC/Scratch/Prefabs/Resources/TemplateDatas";
        public List<TextAsset> TemplateDatas = new List<TextAsset>();


        [Space] [Header("引擎代码生成配置")] public string CsSharpPath = "Assets/Scripts/ScratchFramework/EngineCore";
