...
namespace ScratchFramework
{
    ...
    /// BlockDataUI 管理类
    /// </summary>
    public class BlockDataUIManager : Singleton_Class<BlockDataUIManager>, IScratchManager
    {
        ...
        public void Save()
        {
            ScratchEngine.Instance.Core.SaveBlockFile(ScratchEngine.Instance.FileData, (res) => { Debug.Log("Save Success:" + res); });
        }
    }
}