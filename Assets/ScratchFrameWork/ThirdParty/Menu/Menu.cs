...
namespace Battlehub.UIControls.MenuControl
{
    ...
    public class MenuItemInfo
    {
        ...
        public MenuItemEvent Action = new MenuItemEvent();
        public MenuItemValidationEvent Validate = new MenuItemValidationEvent();
    ...
    public class Menu : ScratchUIBehaviour
    {
        ...
        public override bool Initialize()
        {
            ...
            {
                MenuHelper.AddMenuCommand(Items[i]);
            }
        ...
        private void DataBind()
        {
            ...
            MenuItem m_menuItemPrefab = null;
            EditorUIStyle.GetPrefabStyle(EditorUIStyle.Name_MenuItem, (prefab) =>
            {
                if (prefab != null)
                {
                    m_menuItemPrefab = prefab.GetComponent<MenuItem>();
                }
            });
