...
namespace Battlehub.UIControls.MenuControl
{
    ...
    {
        [SerializeField] private Color m_selectionColor = new Color32(0x00, 0x97, 0xFF, 0xFF);
        ...
        [SerializeField] private Color m_textColor = new Color32(0xFF, 0xFF, 0xFF, 0xFF);
        ...
        [SerializeField] private Color m_disabledSelectionColor = new Color32(0xC5, 0xBF, 0xBF, 0x7F);
        ...
        [SerializeField] private Color m_disableTextColor = new Color32(0x32, 0x32, 0x32, 0xFF);
        ...
        [SerializeField] private GameObject m_expander = null;

        [SerializeField] private Image m_selection = null;

        [SerializeField] private Image m_onIcon = null;
        ...
        private IEnumerator CoSelect()
        {
            ...
            if (HasChildren)
            {
                if (m_submenu == null)
                {
                    EditorUIStyle.GetPrefabStyle(EditorUIStyle.Name_Menu, (prefab) =>
                    {
                        m_submenu = Instantiate(prefab, m_root, false).GetComponent<Menu>();
